...
hebergement::hebergement(int cin,int nb_perso,QString date_depart,QString date_arrive,QString typeChambre, QString typeReservation,QString Nom,QString Prenom){
...
query.prepare("INSERT INTO HEBERGEMENT(NBRPERSONNES,DATEARR,DATEDEP,TYPERES,TYPECHAMBRE,CIN,NOM,PRENOM)"
              " VALUES (:nbp,:DA,:DD,:TypeR,:TypeC,:cin,:nom,:prenom)");
